...
export const metadata: Metadata = buildMetadata({
  ...
  description:
    "東京都葛飾区で軽貨物ドライバーを募集しています。業務委託・1個160円以上の出来高制・日額15,000円の最低保証・ロイヤリティなし。未経験可、AT限定可、車両リース手配可。東京・千葉・埼玉で一緒に配送網をつくる方を探しています。",
  path: "/",
});
...
const features = [
  {
    title: "1個160円以上＋日額15,000円保証",
    body: "配達1個あたり160円以上の出来高制です。出来高が下回った日も日額15,000円をお支払いするため、慣れるまでの期間も収入が落ち込みません。",
  },
  {
    title: "ロイヤリティは0円",
