...
export const metadata: Metadata = buildMetadata({
  ...
  description:
    "軽貨物ドライバー募集。業務委託・日額20,000円〜・ロイヤリティなし、未経験可・AT限定可・車両リース手配可。東京東部・千葉北西部・埼玉東部エリアで、株式会社サイプレス軽貨物事業部と一緒に配送網をつくるドライバーを探しています。",
  path: "/recruit",
});
        ...
        <div className="container-site py-16 md:py-20">
          <div className="grid gap-10 lg:grid-cols-[1fr_1.3fr] lg:gap-16">
            ...
            <div className="space-y-5 text-[15px] leading-[2] text-slate-300">
              <p>
                勤務地、稼働時間、稼働日数、休日、経費の負担区分は、配送案件が確定してから決まります。現時点では固まっていないため、この場に書くことはしていません。
              </p>
              <p>
