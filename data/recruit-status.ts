...
const copy: Record<RecruitPhase, RecruitCopy> = {
  ...
  preparing: {
    ...
    statusBody: [
      "契約形態は業務委託、未経験可、AT限定免許可、車両はリースの手配が可能です。副業としての稼働もご相談いただけます。免許さえあれば始められる体制は用意しています。",
      "一方で、報酬体系・稼働日数・経費の負担区分は、配送案件にあわせて詰めている段階です。確定していない条件を、確定したように書くことはしません。そのため正式な求人票はまだ公開していません。",
      "いまは働き方のご相談と、募集開始のご案内の登録を受け付けています。ご希望のエリアと稼働イメージを伺い、条件が固まった段階でご連絡します。",
    ],
